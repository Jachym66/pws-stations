...
Important: GoGEN weather stations work with Windy using `wu.windy.com` only. The `stations.windy.com` endpoint does not work with these stations because of their upload configuration limitations.
